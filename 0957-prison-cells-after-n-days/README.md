<h2><a href="https://leetcode.com/problems/prison-cells-after-n-days/">957. Prison Cells After N Days</a></h2><h3>Medium</h3><hr><div data-read-aloud-multi-block="true"><p>There are <code>8</code> prison cells in a row and each cell is either occupied or vacant.</p>
...
<p>You are given an integer array <code>cells</code> where <code>cells[i] == 1</code> if the <code>i<sup style="">th</sup></code> cell is occupied and <code>cells[i] == 0</code> if the <code>i<sup style="">th</sup></code> cell is vacant, and you are given an integer <code>n</code>.</p>
